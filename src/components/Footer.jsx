  ...
  return (
    <footer className="bg-slate-900 py-8 mt-10 font-cinzel">
      ...
      <div className="text-center text-gray-500 text-sm mt-4">
        © 2023 Made By Abhi Joshi
      </div>
      <div className="text-center">
        <a
          href="https://www.github.com/abhiness"
          className="text-gray-500 hover:text-white text-center target=_blank"
        >
          Click Here To Visit My Gitbhub!
        </a>
      </div>
    </footer>
  );
